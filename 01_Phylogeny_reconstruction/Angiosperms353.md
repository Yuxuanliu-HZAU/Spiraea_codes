...
The sample name list used in Angiosperms353 dataset can be checked and downloaded [here](https://github.com/Yuxuanliu-HZAU/Spiraea_codes/blob/main/01_Phylogeny_reconstruction/Input_list.txt).
